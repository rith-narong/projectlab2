    ...
    <div class="container">
        <div class="row animate-box">
            <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
                <span>Cool</span>
                <h2>MONEY BOX PRODUCT</h2>
                <p>A money box (also called a piggy bank) is a container used for storing money, often for savings. It's typically small and portable, designed to hold coins, bills, or both.</p>
            </div>
        </div>
        <div class="row">
            <?php
