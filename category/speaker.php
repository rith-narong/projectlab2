    ...
    <div class="container">
        <div class="row animate-box">
            <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
                <span>Cool</span>
                <h2>SPEAKER PRODUCT</h2>
                <p>A speaker is an electronic device that produces sound. It takes electrical signals and converts them into audible sound waves, allowing us to hear music, voices, or any audio played through it.</p>
            </div>
        </div>
        <div class="row">
            <?php
